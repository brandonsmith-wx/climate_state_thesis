...
Global_Mean = False
stf = False
if field == 'TS' and Zonal_Mean is False and Global_Mean is False:
    ...
    outfile_1C = '/home/brandonsmith/modeloutput/Control/1.0/ZM_Background_mappable_Control_1.0.nc'
    outfile_eis1 = '/home/brandonsmith/modeloutput/Control/1.0/map_eis_Control_1.0.nc'
    for CASENAME in casenames:
        ...
        if os.path.isfile(dsloc_control) and os.path.isfile(dsloc):
            ...
            if i == 0:
                ...
                ax.text(-0.1, 0.5, 'a', va='center', rotation='horizontal',transform=ax.transAxes,fontsize=16,color='black')
            else:
            ...
            if i == 0:
                ...
                ax2.text(-0.1, 0.5, 'b', va='center', rotation='horizontal',transform=ax2.transAxes,fontsize=16,color='black')
            else:
            ...
            if i == 0:
                ...
                ax3.text(-0.1, 0.5, 'c', va='center', rotation='horizontal',transform=ax3.transAxes,fontsize=16,color='black')
            else:
            ...
            if i == 0:
                ...
                ax4.text(-0.1, 0.5, 'd', va='center', rotation='horizontal',transform=ax4.transAxes,fontsize=16,color='black')
            else:
            ...
            if i == 0:
                ...
                ax5.text(-0.1, 0.5, 'e', va='center', rotation='horizontal',transform=ax5.transAxes,fontsize=16,color='black')
            else:
            ...
            if i == 0:
                ...
                ax6.text(-0.1, 0.5, 'f', va='center', rotation='horizontal',transform=ax6.transAxes,fontsize=16,color='black')
            else:
            ...
            if i == 0:
                ...
                ax7.text(-0.1, 0.5, 'g', va='center', rotation='horizontal',transform=ax7.transAxes,fontsize=16,color='black')
            else:
