...
normalize = False
stf = False
if field == 'U' and Zonal_Mean is False and Global_Mean is False:
...
#    cb.set_label('Temperature (K)')
    ...
    #plt.suptitle('Low Altitude (Sfc -> 700hPa) Eddy Kinetic Energy Response to Equivalent Radiative Forcing',fontsize=24,y=1.01)
