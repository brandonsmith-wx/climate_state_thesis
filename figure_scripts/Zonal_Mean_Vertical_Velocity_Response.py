...
for CASENAME in casenames:
    ...
    outfile_control = '/ZM_omega_'+run+'_'+CASENAME+'.nc'
    outfile_control_stf = '/ZM_omega_'+run+'_'+CASENAME+'.nc'
...
outfile_1C = '/home/brandonsmith/modeloutput/Control/1.0/ZM_omega_Control_1.0.nc'
outfile_1D = '/home/brandonsmith/modeloutput/2xCO2/1.0/ZM_omega_2xCO2_1.0.nc'
outfile_1Q = '/home/brandonsmith/modeloutput/4xCO2/1.0/ZM_omega_4xCO2_1.0.nc'
...
for CASENAME in casenames:
    outfile_2xco2 = '/ZM_omega_2xCO2_'+CASENAME+'.nc'
    outfile_control = '/ZM_omega_Control_'+CASENAME+'.nc'
    outfile_4xco2 = '/ZM_omega_4xCO2_'+CASENAME+'.nc'
    ...
    if os.path.isfile(dsloc_control) and os.path.isfile(dsloc_2xco2):
        ...
        cs = ax.contourf(lat,lev,Cvar,101, cmap='RdBu',vmin=-0.05,vmax=0.05)
        ...
        if i == 0:
            ...
            cticks=np.around(np.linspace(-0.05,0.05,11),decimals=3)
            ...
            cb = fig.colorbar(mappable=None, norm=Normalize(vmin=-0.05,vmax=0.05), cmap='RdBu',spacing='proportional',orientation='horizontal',cax=cbar_ax,ticks=cticks)
            cb.set_label("Vertical Velocity (Pa/s)",fontsize=14)
        ...
        lat2d, lev2d = np.meshgrid(lat, lev)
        cs2 = ax2.contourf(lat,lev,doubling_response,101, cmap='RdBu',vmin=-0.01,vmax=0.01)
        #cs2 = plt.contourf(lat,lev,doubling_response,60, cmap='BrBG',vmin=-10,vmax=10)

        x = ax2.contour(lat,lev,Dvar,40,colors='black',linewidths=1.0)
        #plt.clabel(x,fontsize='x-small',fmt='%1.0f')
        #plt.clabel(y,fontsize='x-small',fmt='%1.0f')
        ...
        if i == 0:
            ...
            cticks=np.around(np.linspace(-0.01,0.01,5),decimals=3)
            cbar_ax = fig.add_axes([0.22,-0.05,0.18,0.02])
            cb2 = fig.colorbar(mappable=None, norm=Normalize(vmin=-0.01,vmax=0.01), cmap='RdBu',spacing='proportional',orientation='horizontal',cax=cbar_ax,ticks=cticks)
            #cb2 = fig.colorbar(cs2, spacing='proportional',orientation='horizontal',cax=cbar_ax)
            cb2.set_label("Change in Vertical Velocity",fontsize=14)
        ...
        lat2d, lev2d = np.meshgrid(lat, lev)
        cs3 = ax3.contourf(lat,lev,diff,101, cmap='RdBu',vmin=-0.01,vmax=0.01)
        #cs3 = plt.contourf(lat,lev,diff,60, cmap='BrBG',vmin=-10,vmax=10)

        x = ax3.contour(lat,lev,Dvar,40,colors='black',linewidths=1.0)
        #plt.clabel(x,fontsize='x-small',fmt='%1.0f')
        #plt.clabel(y,fontsize='x-small',fmt='%1.0f')
        ...
        if i == 0:
            ...
            cb3 = fig.colorbar(mappable=None, norm=Normalize(vmin=-0.01,vmax=0.01), cmap='RdBu',spacing='proportional',orientation='horizontal',cax=cbar_ax,ticks=cticks)
        ...
        lat2d, lev2d = np.meshgrid(lat, lev)
        cs4 = ax4.contourf(lat,lev,Quad_response,101, cmap='RdBu',vmin=-0.01,vmax=0.01)
        #cs4 = plt.contourf(lat,lev,Quad_response,60, cmap='BrBG',vmin=-10,vmax=10)
        x = ax4.contour(lat,lev,Qvar,40,colors='black',linewidths=1.0)
        #plt.clabel(x,fontsize='x-small',fmt='%1.0f')
        #plt.clabel(y,fontsize='x-small',fmt='%1.0f')
        #cs3.set_edgecolor("face")
        ...
        if i == 0:
            ...
            cb4 = fig.colorbar(mappable=None, norm=Normalize(vmin=-0.01,vmax=0.01), cmap='RdBu',spacing='proportional',orientation='horizontal',cax=cbar_ax,ticks=cticks)
            #cb4 = fig.colorbar(cs4, spacing='proportional',orientation='horizontal',cax=cbar_ax)
            cb4.set_label('Change in Vertical Velocity',fontsize=14)
        ...
        lat2d, lev2d = np.meshgrid(lat, lev)
        cs5 = ax5.contourf(lat,lev,Qdiff,101, cmap='RdBu',vmin=-0.01,vmax=0.01)
        #cs5 = plt.contourf(lat,lev,Qdiff,60, cmap='BrBG',vmin=-10,vmax=10)
        x = ax5.contour(lat,lev,Qvar,40,colors='black',linewidths=1.0)
        #plt.clabel(x,fontsize='x-small',fmt='%1.0f')
        #plt.clabel(y,fontsize='x-small',fmt='%1.0f')
        #cs3.set_edgecolor("face")
        ...
        if i == 0:
            ...
            cb5 = fig.colorbar(mappable=None, norm=Normalize(vmin=-0.01,vmax=0.01), cmap='RdBu',spacing='proportional',orientation='horizontal',cax=cbar_ax,ticks=cticks)
...
if normalize is False:
    fig.suptitle('Zonal Mean Vertical Velocity Response to $CO_2$ Doubling',y=1.01,fontsize=24)
else:
    fig.suptitle('Zonal Mean Vertical Velocity Response to Equivalent Radiative Forcing',y=1.01,fontsize=24)
fig.tight_layout(pad=0.2)
fig.text(-0.04, 0.5, 'Hybrid Sigma-Pressure Level (mb)', va='center', rotation='vertical',fontsize=16)
plt.show()
if normalize is False:
    fig.savefig(figure_path+'Zonal_Mean_OMEGA_2x_response.pdf',bbox_inches='tight')
else:
    fig.savefig(figure_path+'Zonal_Mean_OMEGA_n_response.pdf',bbox_inches='tight')
###################################################################################################################################################