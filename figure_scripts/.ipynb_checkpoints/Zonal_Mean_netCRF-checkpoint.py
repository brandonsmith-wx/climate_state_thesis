...
for CASENAME in casenames:
    ...
    ax.set_ylabel('CRF ($W/m^2$)',fontsize=12)
    ax.set_xticks(ticks)
    ...
    ax2.set_ylabel('$\Delta$ CRF ($W/m^2$)',fontsize=12)
    if i == 0:
    ...
    ax4.set_ylabel('$\Delta$ CRF ($W/m^2$)',fontsize=12)
    if i == 0:
        if normalize is False:
...
'''
if normalize is False:
    fig.suptitle('Net Cloud Forcing',fontsize=24)
else:
    fig.suptitle('Net Cloud Forcing',fontsize=16,y=1.05)
    
'''
if normalize is False:
    fig.suptitle('Zonal Mean Net Cloud Forcing Response to $CO_2$ Doubling',fontsize=24)
else:
    fig.suptitle('Zonal Mean Net Cloud Forcing Response to Equivalent Radiative Forcing',fontsize=16,y=1.05)
