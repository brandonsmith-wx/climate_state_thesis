...
#
# Script for plotting figure 3.16. for altercation, make necessary comments and uncomments
...
for CASENAME in casenames:
    run = 'Control'
    inpath = '/home/brandonsmith/modeloutput/'+run+'/'+CASENAME # change location of parent data set
...
if normalize is False:
    ...
    fig.savefig(figure_path+'map_CLDHGH_n_response.pdf',bbox_inches='tight')
