...
for CASENAME in casenames:
    ...
    outfile_control = '/map_CLDLOW_'+run+'_'+CASENAME+'.nc'
...
plt.show()
if normalize is False:
    fig.savefig(figure_path+'map_CLDLOW_2x_response.pdf',bbox_inches='tight')
else:
    fig.savefig(figure_path+'map_CLDLOW_n_response.pdf',bbox_inches='tight')
