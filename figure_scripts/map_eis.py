...
#
# Script for plotting figure 3.10. for altercation, make necessary comments and uncomments
...
if normalize is False:
    ...
    fig.savefig(figure_path+'Map_eis_n_response.pdf',bbox_inches='tight')
